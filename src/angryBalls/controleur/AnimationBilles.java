...
public class AnimationBilles implements Runnable, Animation {
	...
	public AnimationBilles(Vector<Bille> billes, VueBillard vueBillard) {
		...
		this.vueBillard.ajoutCapaciteArretAnimation(this);
		this.vueBillard.ajoutCapaciteLancementAnimation(this);
	}
		...
		try {
			...
			while (!Thread.interrupted()) // gestion du mouvement
			{
													...
													// des billes
				{
					...
					billeCourante.collisionContour(0, 0,
							vueBillard.largeurBillard(),
							vueBillard.hauteurBillard()); // System.err.println("billes = "
															// + billes);
				}
	...
	public VueBillard getVueBillard() {
		return vueBillard;
	}

	@Override
	public void update(Observable o, Object arg) {
		((ResponsableAnimation) arg).action(this);
	}
