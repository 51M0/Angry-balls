...
public class BilleRectiligne extends Observable implements Bille {
	 ...
	 * @param couleur
	 */
	private BilleRectiligne(Vecteur centre, double rayon, Vecteur vitesse, Vecteur accélération, String couleur) {
	...
	@Override
	public double masse() {
		return BilleRectiligne.ro * Geop.volumeSphère(this.getRayon());
	}
